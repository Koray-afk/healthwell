  ...
  return (
    <Section className="pb-24 pt-32 sm:pt-40">
      <Container className="flex max-w-2xl flex-col items-center justify-center">
        ...
        <div className="w-full rounded-3xl bg-white p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] ring-1 ring-border sm:p-10">
          <form className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              <select required defaultValue="" className="w-full appearance-none rounded-xl border border-border bg-transparent px-4 py-3 text-sm outline-none transition-colors focus:border-[#1D5BFF] focus:ring-1 focus:ring-[#1D5BFF]">
